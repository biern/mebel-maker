...
function starterState(): SketchState {
  ...
  const boards: Board[] = [
    ...
    { id: 2, name: "Right side", x: 962, y: 120, w: thickness, h: 560, kind: "upright", autoThickness: "width", materialId, thicknessOverride: null, depthOverride: null, laminate: laminate(), ignoreInOrder: false, group: 0 },
    { id: 3, name: "Top", x: 178, y: 120, w: 784, h: thickness, kind: "shelf", autoThickness: "height", materialId, thicknessOverride: null, depthOverride: null, laminate: laminate(), ignoreInOrder: false, group: 0 },
    { id: 4, name: "Bottom", x: 178, y: 662, w: 784, h: thickness, kind: "shelf", autoThickness: "height", materialId, thicknessOverride: null, depthOverride: null, laminate: laminate(), ignoreInOrder: false, group: 0 },
    { id: 5, name: "Middle shelf", x: 178, y: 395, w: 784, h: thickness, kind: "shelf", autoThickness: "height", materialId, thicknessOverride: null, depthOverride: null, laminate: laminate(), ignoreInOrder: false, group: 0 }
  ];
  return {
    boards,
    anchors: [],
